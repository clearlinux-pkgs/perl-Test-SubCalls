...
cp %{_builddir}/Test-SubCalls-1.10/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-SubCalls/f02c5c32ea4eb38241a1a5f3f6c03301a1051dc9
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Test/SubCalls.pm
